...
pg.display.set_caption(("Ping-pong Game"))   #设置屏幕标题
...
while True:
    ...
    printtext(zt1,"Move mouse to control",20,30,white)
    printtext(zt2,"Scored!",550,12,cs)
...
printtext(zt3,"Game Over - Buy an Insurance for Guarantee?",60,120,white)
printtext(zt4,'Your score: '+str(fs),120,400,white)
pg.display.update()